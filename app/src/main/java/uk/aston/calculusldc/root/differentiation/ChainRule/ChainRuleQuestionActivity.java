...
public class ChainRuleQuestionActivity extends AppCompatActivity
{
    private final ChainRuleQuizInventory mQuestionLibrary = new ChainRuleQuizInventory();
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber<mQuestionLibrary.getLength() ){
            ...
            Intent intent = new Intent(ChainRuleQuestionActivity.this, ChainRuleBestScoreActivity.class);
    ...
    public void onClick(View view)
    {
        ...
        {
            mScore = mScore + 1;
             Toast.makeText(ChainRuleQuestionActivity.this, "Correct!", Toast.LENGTH_SHORT).show();
        }else
            Toast.makeText(ChainRuleQuestionActivity.this, "Wrong!", Toast.LENGTH_SHORT).show();
        // show current total score for the user
        updateScore(mScore);
