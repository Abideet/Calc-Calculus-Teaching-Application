...
public class ImplicitDiffBestScoreActivity extends AppCompatActivity
{
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(item.getItemId())
                {
                    ...
                    case R.id.savedFragment:
                        ...
                        NavController navController2 = Navigation.findNavController(ImplicitDiffBestScoreActivity.this,R.id.fContainerHighScore);
    ...
    {
        Intent intent = new Intent(ImplicitDiffBestScoreActivity.this, ImplicitDiffQuestionActivity.class);
