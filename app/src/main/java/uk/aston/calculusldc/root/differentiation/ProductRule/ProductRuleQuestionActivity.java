...
public class ProductRuleQuestionActivity extends AppCompatActivity
{

    private final ProductRuleQuizInventory mQuestionLibrary = new ProductRuleQuizInventory();
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mQuestionText.setText("Calculate the derivative of the following functions using the product rule & select the correct answer.");
        ...
        mQuestionView.setLatex("$y =(x+1)sin(4x) ");
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber<mQuestionLibrary.getLength() ){
            ...
            if(mQuestionNumber == 1)
            {
                ...
                mQuestionView1.setLatex("$y = x^8e^{-4x}");
                mQuestionView1.setFontSize(70);
            }
            else if (mQuestionNumber == 2)
            {

                mQuestionView1.setLatex("$y=cos(2x)sin(5x)");

            } else if (mQuestionNumber == 3)
            {
                mQuestionView1.setLatex("$y=(3x−5)sin(x)");
            }
            ...
            Toast.makeText(ProductRuleQuestionActivity.this, "It was the last question!", Toast.LENGTH_SHORT).show();


            Score score = new Score();
            score.setmTopic("Product Rule");
            ...
            Intent intent = new Intent(ProductRuleQuestionActivity.this, ProductRuleBestScoreActivity.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText().equals(mAnswer)){
            mScore = mScore + 1;
             Toast.makeText(ProductRuleQuestionActivity.this, "Correct!", Toast.LENGTH_SHORT).show();
        }else
            Toast.makeText(ProductRuleQuestionActivity.this, "Wrong!", Toast.LENGTH_SHORT).show();
        // show current total score for the user
        updateScore(mScore);
