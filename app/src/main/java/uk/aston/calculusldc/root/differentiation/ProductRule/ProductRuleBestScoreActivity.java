...
public class ProductRuleBestScoreActivity extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(item.getItemId())
                {
                    ...
                    case R.id.savedFragment:
                        ...
                        NavController navController2 = Navigation.findNavController(ProductRuleBestScoreActivity.this,R.id.fContainerHighScore);
    ...
    {
        Intent intent = new Intent(ProductRuleBestScoreActivity.this, ProductRuleQuestionActivity.class);
