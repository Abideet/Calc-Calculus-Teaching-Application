...
public class StatPointsQuestionActivity extends AppCompatActivity
{

    private final StatPointsQuizInventory mQuestionLibrary = new StatPointsQuizInventory();
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber<mQuestionLibrary.getLength() ){
            ...
            Toast.makeText(StatPointsQuestionActivity.this, "It was the last question!", Toast.LENGTH_SHORT).show();
            ...
            Intent intent = new Intent(StatPointsQuestionActivity.this, StatPointsBestScoreActivity.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText().equals(mAnswer)){
            mScore = mScore + 1;
             Toast.makeText(StatPointsQuestionActivity.this, "Correct!", Toast.LENGTH_SHORT).show();
        }else
            Toast.makeText(StatPointsQuestionActivity.this, "Wrong!", Toast.LENGTH_SHORT).show();
        // show current total score for the user
        updateScore(mScore);
