            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(item.getItemId())
                {
                    ...
                    case R.id.graphCalculateFragment:
                        ...
                        NavController navController = Navigation.findNavController(uk.aston.calculusldc.root.differentiation.ImplicitDiff.HighestScoreActivity.this,R.id.fContainerHighScore);
                    ...
                    case R.id.savedFragment:
                        ...
                        NavController navController2 = Navigation.findNavController(uk.aston.calculusldc.root.differentiation.ImplicitDiff.HighestScoreActivity.this,R.id.fContainerHighScore);
