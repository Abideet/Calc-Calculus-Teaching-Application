...
public class VariousFunctionsDiffBestScoreActivity extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(item.getItemId())
                {
                    ...
                    case R.id.savedFragment:
                        ...
                        NavController navController2 = Navigation.findNavController(VariousFunctionsDiffBestScoreActivity.this,R.id.fContainerHighScore);
    ...
    {
        Intent intent = new Intent(VariousFunctionsDiffBestScoreActivity.this, VariousFunctionsDiffQuestionActivity.class);
