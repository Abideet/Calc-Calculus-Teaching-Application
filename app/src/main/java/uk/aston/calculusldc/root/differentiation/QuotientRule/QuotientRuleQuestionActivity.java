...
public class QuotientRuleQuestionActivity extends AppCompatActivity
{

    private final QuotientRuleQuizInventory mQuestionLibrary = new QuotientRuleQuizInventory();
    ...
    protected void onCreate(Bundle savedInstanceState)
    {
        ...
        mQuestionText.setText("Differentiate the following functions using the quotient rule & select the correct answer.");
        ...
        mQuestionView.setLatex("$y = \\frac{7x+2}{6x+8}");
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber<mQuestionLibrary.getLength() ){
            ...
            if(mQuestionNumber == 1)
            {
                ...
                mQuestionView1.setLatex("$y = \\frac{cos(3x)}{sin(4x)}");
                mQuestionView1.setFontSize(70);
            }
            else if (mQuestionNumber == 2)
            {

                mQuestionView1.setLatex("$y = \\frac{Ln(4x)}{e^{5x}}");

            } else if (mQuestionNumber == 3)
            {
                mQuestionView1.setLatex("$y = \\frac{4x+8}{3x+5}");
            }
            ...
            Toast.makeText(QuotientRuleQuestionActivity.this, "It was the last question!", Toast.LENGTH_SHORT).show();

            Score score = new Score();
            score.setmTopic("Quotient Rule");
            ...
            Intent intent = new Intent(QuotientRuleQuestionActivity.this, QuotientRuleBestScoreActivity.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText().equals(mAnswer)){
            mScore = mScore + 1;
             Toast.makeText(QuotientRuleQuestionActivity.this, "Correct!", Toast.LENGTH_SHORT).show();
        }else
            Toast.makeText(QuotientRuleQuestionActivity.this, "Wrong!", Toast.LENGTH_SHORT).show();
        // show current total score for the user
        updateScore(mScore);
