...
public class ImplicitDiffQuestionActivity extends AppCompatActivity
{

    private final ImplicitDiffQuizInventory mQuestionLibrary = new ImplicitDiffQuizInventory();
    ...
    private void updateQuestion(){
        ...
        if(mQuestionNumber<mQuestionLibrary.getLength() ){
            ...
            Toast.makeText(ImplicitDiffQuestionActivity.this, "It was the last question!", Toast.LENGTH_SHORT).show();
            ...
            Intent intent = new Intent(ImplicitDiffQuestionActivity.this, ImplicitDiffBestScoreActivity.class);
    ...
    public void onClick(View view) {
        ...
        if (answer.getText().equals(mAnswer)){
            mScore = mScore + 1;
             Toast.makeText(ImplicitDiffQuestionActivity.this, "Correct!", Toast.LENGTH_SHORT).show();
        }else
            Toast.makeText(ImplicitDiffQuestionActivity.this, "Wrong!", Toast.LENGTH_SHORT).show();
        // show current total score for the user
        updateScore(mScore);
