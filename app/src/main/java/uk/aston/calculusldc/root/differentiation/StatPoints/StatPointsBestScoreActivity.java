...
public class StatPointsBestScoreActivity extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(item.getItemId())
                {
                    ...
                    case R.id.savedFragment:
                        ...
                        NavController navController2 = Navigation.findNavController(StatPointsBestScoreActivity.this,R.id.fContainerHighScore);
    ...
    {
        Intent intent = new Intent(StatPointsBestScoreActivity.this, StatPointsQuestionActivity.class);
