...
public class ChainRuleBestScoreActivity extends AppCompatActivity {
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                ...
                switch(item.getItemId())
                {
                    ...
                    case R.id.savedFragment:
                        ...
                        NavController navController2 = Navigation.findNavController(ChainRuleBestScoreActivity.this,R.id.fContainerHighScore);
    ...
    {
        Intent intent = new Intent(ChainRuleBestScoreActivity.this, ChainRuleQuestionActivity.class);
